...
if($p[1] == "our-adventures" && $p[2] == "kinabalu-national-park" && $p[3] == "rock-gorge-trek") {
	$t = "Kinabalu National Park | Rock Gorge Trek, Mount Kinabalu Packages";
	$d = "Book amazing borneo holidays with Sticky Rice. Rock Gorge Trek will take your mind away. Meaningful Adventures!";	
}
...
if($p[1] == "our-adventures" && $p[2] == "kota-kinabalu" && $p[3] == "quad-biking") {
	$t = "Kota Kinabalu | Kiulu Quad Biking";
	$d = "Book amazing borneo holidays with Sticky Rice. Discover Dusun Tribe & longhouse accommodation by the banks of the Kedamaian River. Meaningful Adventures!";	
}
...
include './header.php';
	...
	$notfound = true;
	if(isset($p[1])){
		if($p[1] == "home" || $p[1] == ""){$tempUrl = "k/base";}
		else{$tempUrl = "k/".$p[1];}
	}
